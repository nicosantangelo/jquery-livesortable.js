...
this._socketEventer=new l(this);this.getSocket=function(){return this._socketEventer.socket};this.options.cancelSedingInRealtime||this.addMousemoveHandler();return this}if(d===g)throw"jQuery should be defined to use liveSortable";if(!1 in d.fn)throw"jQuery UIs sortable should be defined to use liveSortable";var k={cancelRealtime:!1,cancelSedingInRealtime:!1,delay:0,events:{start:function(){},beforeStop:function(){},stop:function(){},mousemove:function(){}},sortable:{helper:"clone",start:function(a,
