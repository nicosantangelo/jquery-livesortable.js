...
this._socketEventer=new l(this);this.getSocket=function(){return this._socketEventer.socket};this.options.cancelSendingInRealtime||this.addMousemoveHandler();return this}if(d===g)throw"jQuery should be defined to use liveSortable";if(!("sortable"in d.fn))throw"jQuery UIs sortable should be defined to use liveSortable";var k={cancelRealtime:!1,cancelSendingInRealtime:!1,delay:0,events:{start:function(){},beforeStop:function(){},stop:function(){},mousemove:function(){}},sortable:{helper:"clone",start:function(a,
...
remove:function(){this.$element.removeData("plugin_liveSortable").off(f.sufix);this._socketEventer.removeAllEvents();return this.$element},toggleOption:function(a){this.options[a]=!this.options[a];return this.options[a]},toggleRealtime:function(){var a=f.addSufix("moving_element");this.toggleOption("cancelRealtime")?this._socketEventer.removeEvent(a):this._socketEventer.addEvent(a)},toggleRealtimeSending:function(){this.toggleOption("cancelSendingInRealtime")?this.removeMousemoveHandler():this.addMousemoveHandler()},
